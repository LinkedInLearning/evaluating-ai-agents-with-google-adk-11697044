...
This chapter focuses on running evaluations at scale, not modifying
agent logic.
"""
...
# ---------------------------------------------------------------------------
root_agent = Agent(
    name="headless_eval_agent",
    description="Procurement agent used for headless batch evaluation.",
