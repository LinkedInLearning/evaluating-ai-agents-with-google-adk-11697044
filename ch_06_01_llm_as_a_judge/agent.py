...
This chapter focuses on evaluating the qualitative aspects of agent
responses (tone, professionalism, refusal quality) using ADK's built-in
...
root_agent = Agent(
    ...
    description="Procurement agent evaluated with LLM-as-a-Judge rubrics.",
