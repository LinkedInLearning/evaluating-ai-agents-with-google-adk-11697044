...
This chapter focuses on verifying that every claim in the agent's
response is grounded in actual tool outputs, not fabricated.
"""
...
root_agent = Agent(
    ...
    description="Procurement agent evaluated for groundedness and faithfulness.",
